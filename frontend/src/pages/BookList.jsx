                                ...
                                <td className="px-6 py-5 text-right">
                                    <div className="flex justify-end gap-2">
                                        <button
                                            ...
                                            className="px-3 py-2 rounded-lg transition-all flex items-center gap-1.5 text-sm font-medium bg-blue-50 hover:bg-blue-100 text-blue-600 border border-blue-100"
                                            title="开始阅读"
                                        >
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
